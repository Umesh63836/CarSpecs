...
#pragma warning disable OPENAI001 
        ...
        private const string SearchCarsParameterSchema = """
        {
            ...
            "properties": {
                ...
                "MinPrice": {
                    "type": ["number", "null"],
                    "description": "Minimum ex-showroom price in INR. The database stores prices as absolute rupees(INR)."
                },
                "MaxPrice": {
                    "type": ["number", "null"],
                    "description": "Maximum ex-showroom price in INR. The database stores prices as absolute rupees(INR)."
                }
            },
            "required": [
                "Brand",
...
#pragma warning disable OPENAI001 
        ...
        13. Prices are expressed in absolute INR.
            For example:
            10 Lakhs means ₹10,00,000
            12.5 Lakhs means ₹12,50,000
            15 Lakhs means ₹15,00,000
        ...
        25. Examples:
            ...
            → Keep all existing requirements and change only maximum price to ₹1500000.
